...
export function ShareSection() {
  ...
  const handleShare = async (customMessage?: string) => {
    const message =
      customMessage || "Check out this awesome relationship learning app! 💝";
  ...
  const shareOptions: ShareOption[] = [
    {
      ...
      action: () =>
        handleShare(
          "Hey! 👋 Found this awesome app for improving relationship skills"
        ),
    },
    {
      id: "twitter",
      ...
      action: () =>
        handleShare("Learning relationship skills with this amazing app! 🚀"),
    },
    {
      id: "reddit",
      title: "Reddit",
          ...
          >
            <ThemedView
              style={[
                ...
                { backgroundColor: option.color } as ViewStyle,
              ]}
            >
              <IconSymbol
