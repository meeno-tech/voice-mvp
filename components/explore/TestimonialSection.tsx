...
export function TestimonialSection() {
  return (
    <Animated.View entering={FadeInUp.delay(800).springify()} style={styles.testimonialsSection}>
      ...
      <ScrollView
        ...
        {testimonials.map((testimonial, index) => (
          <ThemedView key={index} style={styles.testimonialCard}>
            <ThemedText style={styles.testimonialText}>{`"${testimonial.text}"`}</ThemedText>
            <ThemedText style={styles.testimonialAuthor}>- {testimonial.author}</ThemedText>
          </ThemedView>
        ))}
      </ScrollView>
    </Animated.View>
